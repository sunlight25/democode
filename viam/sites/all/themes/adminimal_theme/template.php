 ...
 *  Alter primary tab for merchant and venues user role 
 *  Edit by $urya
 */
function adminimal_menu_local_tasks_alter(&$data, $router_item, $root_path) {            
    
    global $user;
    if (in_array('merchant', $user->roles) || in_array('Venue User', $user->roles)) { 
        unset($data['tabs']);

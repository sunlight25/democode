...
<div class="<?php print $classes; ?>">
  ...
  <?php if ($rows): ?>
    <div class="view-content">       
        ...
        ?> 
        <div id="hero_title" class="mb-0 center-align white-text t-bg">
            <h1 class="display-5 text-uppercase"><?php echo t('The').' '; ?><?php echo isset($rows[0]['title_1'])?$rows[0]['title_1']:'--' ?></h1>                        
            <h2 class="upper h6">
                    <a id="event_info_toggle" class="white-text" href="confirmation.php"><?php print t('View Confirmation and Package'); ?></a>
            </h2>	
        </div>

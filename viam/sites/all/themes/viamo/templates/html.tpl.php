...
<head>
  ...
  <!-- Fonts -->
  <?php global $base_url; ?>
  <link rel="stylesheet" href="<?php print $base_url; ?>/sites/all/themes/viamo/assets/fonts/lineicons/flaticon.css" type="text/css" charset="utf-8"/>
  ...
  <![endif]-->  
    ...
    <body<?php print $body_attributes; ?>>
      <div id="skip-link">
        ...
        <div id="page" class="wrapper scrollbar-dynamic">                       
        <?php global $base_url; ?>                   
        <?php print $scripts; ?>            
        <?php print $page_top; ?>
        <?php print $page; ?>

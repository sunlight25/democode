        ...
        <div class="row">
            ...
            <div class="col l3 m3 s6">
                <div class="product-item">
                    ...
                    <h6 class="item-name"><?php print $row['title']; ?></h6>
                    ...
                    <span class="more-info"><a href="<?php print $row['path'];?>" title="<?php print t('More Information'); ?>"><?php print t('More Information'); ?></a></span>                    
                </div>
            </div>            
            <?php } ?>                           
        </div>

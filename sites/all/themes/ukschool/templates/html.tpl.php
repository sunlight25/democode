...
<?php global $base_url; ?>       
<link rel="stylesheet" href="<?php echo $base_url; ?>/<?php echo drupal_get_path('theme', 'ukschool').'/fonts/font-awesome.min.css'; ?>" type="text/css" media="screen">
  ...
  <link href="http://cdn.materialdesignicons.com/1.8.36/css/materialdesignicons.min.css" rel="stylesheet" type="text/css"/>
</head>

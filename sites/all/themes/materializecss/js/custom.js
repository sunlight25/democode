...
/*jQuery(".popup-field-group-link").live("click",function() {
	 jQuery.getScript("misc/autocomplete.js");
	 jQuery.getScript("sites/all/modules/autocomplete_deluxe/autocomplete_deluxe.js");
